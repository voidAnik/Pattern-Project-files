...
def MLP_Classifier(X, y, indep=None, fold=5, hidden_layer_size=(32, 32)):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--hidden", default="32:32",
                        help="hidden layer size, the ith element represents the number of neurons in the ith hidden layer.")
    ...
    para_info, cv_res, ind_res = MLP_Classifier(X, y, indep=independent, fold=args.fold,
